...
/** @defgroup COM_SOCKETS_Functions_IP_MODEM IP Modem Socket services
  * @{
  */
...
/** @defgroup COM_SOCKETS_Functions_IP_MODEM_Other IP Modem Other Socket services
  * @{
  */
...
/** @defgroup COM_PING_Functions_IP_MODEM IP Modem Ping services
  * @{
  */
