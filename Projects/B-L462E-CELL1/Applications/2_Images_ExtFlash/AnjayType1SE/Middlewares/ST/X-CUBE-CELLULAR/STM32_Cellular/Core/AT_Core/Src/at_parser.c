...
/** @defgroup AT_CORE_PARSER_Private_Macros AT_CORE PARSER Private Macros
  * @{
  */
...
/** @defgroup AT_CORE_PARSER_Private_Defines AT_CORE PARSER Private Defines
  * @{
  */
...
/** @defgroup AT_CORE_PARSER_Private_Structure AT_CORE PARSER Private Structure
  * @{
  */
typedef struct
{
...
/** @defgroup AT_CORE_PARSER_Private_Functions_Prototypes AT_CORE PARSER Private Functions Prototypes
  * @{
  */
...
/** @defgroup AT_CORE_PARSER_Private_Functions AT_CORE PARSER Private Functions
  * @{
  */
/**
