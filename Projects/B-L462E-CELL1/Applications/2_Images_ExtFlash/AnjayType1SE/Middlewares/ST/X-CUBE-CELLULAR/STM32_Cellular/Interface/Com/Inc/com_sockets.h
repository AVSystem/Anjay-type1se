...
/**
  ******************************************************************************
  @verbatim
  ==============================================================================
                      ##### How to use COM Ping Module #####
  ==============================================================================
  Allows to ping a Remote host
  ...
  com_ping interface offers a generic interface whatever the IP configuration selection.
  For each com_ping services there is a declination in :
  - com_ping_lwip_mcu module when LwIP is on MCU side
  - com_ping_ip_mcu module when IP is on Modem side
...
/**
  ******************************************************************************
  @verbatim
  ==============================================================================
                      ##### How to use COM Sockets Module #####
  ==============================================================================
  Allows to communicate with a Remote host using IP protocol

  IP stack can be at two different exclusive places:
  1) on MCU side : LwIP (when USE_SOCKETS_TYPE = USE_SOCKETS_LWIP)
  2) on Modem side : Modem socket (when USE_SOCKETS_TYPE = USE_SOCKETS_MODEM)

  com_sockets interface offers a generic interface whatever the IP configuration selection.
...
/** @defgroup COM_SOCKETS_Functions_Generic Generic Socket services
  * @{
  */
...
/** @defgroup COM_SOCKETS_Functions_Generic_Other Other Generic Socket services
  * @{
  */
...
/** @defgroup COM_SOCKETS_Functions_Other Other Generic services
  * @{
  */
...
/** @defgroup COM_PING_Functions_Generic Generic Ping services
  * @{
  */
